...
#define SDE_MDP_HW_REV_400	SDE_MDP_REV(4, 0, 0)
#define SDE_MDP_HW_REV_410	SDE_MDP_REV(4, 1, 0)
#define SDE_MDP_HW_REV_500	SDE_MDP_REV(5, 0, 0)
#define SDE_MDP_HW_REV_520	SDE_MDP_REV(5, 2, 0)
#define SDE_MDP_HW_REV_530	SDE_MDP_REV(5, 3, 0)
